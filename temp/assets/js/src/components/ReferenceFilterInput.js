...
exports.ReferenceFilterInput = undefined;
...
var _Labeled = require('admin-on-rest/lib/mui/input/Labeled');

var _Labeled2 = _interopRequireDefault(_Labeled);

var _dataActions = require('admin-on-rest/lib/actions/dataActions');

var _possibleValues = require('admin-on-rest/lib/reducer/admin/references/possibleValues');
 ...
 *     <Edit {...props}>
 *         <SimpleForm>
 *             <ReferenceFilterInput label="Post" source="post_id" reference="posts">
 ...
 * </ReferenceFilterInput>
 *
 * The enclosed component may filter results. ReferenceFilterInput passes a `setFilter`
...
var ReferenceFilterInput = exports.ReferenceFilterInput = function (_Component) {
    (0, _inherits3.default)(ReferenceFilterInput, _Component);

    function ReferenceFilterInput(props) {
        (0, _classCallCheck3.default)(this, ReferenceFilterInput);

        var _this = (0, _possibleConstructorReturn3.default)(this, (ReferenceFilterInput.__proto__ || Object.getPrototypeOf(ReferenceFilterInput)).call(this, props));
        ...
        var perPage = props.perPage,
            sort = props.sort,
            filter = props.filter;
        this.props.filter[this.props.filterToField] = 1;
    ...
    (0, _createClass3.default)(ReferenceFilterInput, [{
...
ReferenceFilterInput.propTypes = {
    ...
    filterToField: _propTypes2.default.string,
...
ReferenceFilterInput.defaultProps = {
    addField: true,
    allowEmpty: false,
    filter: {},
...
var ConnectedReferenceFilterInput = (0, _reactRedux.connect)(mapStateToProps, {
    crudGetOne: _dataActions.crudGetOne,
    crudGetMatching: _dataActions.crudGetMatching
})(ReferenceFilterInput);

ConnectedReferenceFilterInput.defaultProps = {
    addField: true
};

exports.default = ConnectedReferenceFilterInput;